1.21 LIVONIA Building, Hunting, Farming, Fishing & Trading PvE xml Mod Changelog & Terms Of Use

Limited Testing on PC Livonia Local Server DAYZ  Version 1.21 Mar 2023.
...
Latest 1.21 Items added, crossbows, bolts, armour, swords, mace, etc, DONE.
...
The type="Truck_01_Covered_Orange" has weapons when spawned, but by default is disabled in events. Remove comments brackets to enable, will start spawning in random locations. WARNING: LOTS MIGHT SPAWN!

The type="Truck_01_Covered_Blue" has party items when spawned, but by default is disabled in events. Remove comments brackets to enable, will start spawning in random locations. WARNING! LOTS MIGHT SPAWN!
